...
export default function CollectionScreen() {
  ...
  const { collections, decks, cards, dueByDeck, addDeckToCollectionMut } = useApp();
              ...
              {availableDecks.length === 0 ? (
                ...
                availableDecks.map((deck) => (
                  <Pressable
                    ...
                    onPress={() => {
                      void handleAddDeck(deck.id);
                    }}
                    disabled={busy}
                  >
                    <View style={styles.deckRowMain}>
                      <Text style={[styles.deckRowTitle, { color: colors.foreground }]} numberOfLines={1}>
                        {deck.name}
                      </Text>
                      <Text style={[styles.deckRowSub, { color: colors.mutedForeground }]}>
                        {deck.dialect}
                      </Text>
                    </View>
